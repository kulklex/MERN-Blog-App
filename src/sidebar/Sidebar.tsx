    ...
    <div className="sideBar bg-white rounded-lg flex flex-col items-center">
      ...
      <div className="sideBarItem flex flex-col items-center">
        ...
        <ul className="sideBarList list-none mb-4">
            <li className="sideBarListItem inline-block w-1/2 mt-4 cursor-pointer">Life</li>
            <li className="sideBarListItem inline-block w-1/2 mt-4 cursor-pointer">Music</li>
            <li className="sideBarListItem inline-block w-1/2 mt-4 cursor-pointer">Style</li>
            <li className="sideBarListItem inline-block w-1/2 mt-4 cursor-pointer">Sport</li>
            <li className="sideBarListItem inline-block w-1/2 mt-4 cursor-pointer">Tech</li>
            <li className="sideBarListItem inline-block w-1/2 mt-4 cursor-pointer">Cinema</li>
        </ul>
      </div>
      <div className="sideBarItem flex flex-col items-center">
