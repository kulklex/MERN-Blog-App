      ...
      <div className="w-full h-12 sticky top-0 flex items-center font-serif">
        ...
        <div className="topCenter">
          <ul className="topList flex justify-between m-0 p-0 list-none">
            <li className="topListItem text-lg font-light">HOME</li>
            <li className="topListItem text-lg font-light">ABOUT</li>
            <li className="topListItem text-lg font-light">CONTACT</li>
            <li className="topListItem text-lg font-light">WRITE</li>
            <li className="topListItem text-lg font-light">LOGOUT</li>
          </ul>
        </div>
